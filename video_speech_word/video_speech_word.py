...
if __name__ == '__main__':
    # 拿到新生成的音频的路径
    path = extract_audio('/media/hxzh02/mobilePan/AICA6首席架构师计划/预科班/AICA6－搭建适合企业的AI中台.mp4')
    # 划分音频
    path = qiefen(path=path, ty='video1', mmin_dur=0.5, mmax_dur=100000, mmax_silence=0.5, menergy_threshold=55)
    # 音频转文本  需要GPU
